...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        ...
        {
            Count = reader.IsDBNull(0) ? null : global::Qread.TypeReaders.TryGetReader<short>(out var readerCount) && readerCount is not null ? readerCount.Read(reader, 0) : reader.GetInt16(0),
            Count2 = reader.IsDBNull(1) ? null : global::Qread.TypeReaders.TryGetReader<Int16>(out var readerCount2) && readerCount2 is not null ? readerCount2.Read(reader, 1) : reader.GetInt16(1)
        };
        return instance;
    }
