...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        ...
        {
            Count = reader.IsDBNull(0) ? null : global::Qread.TypeReaders.TryGetReader<int>(out var readerCount) ? readerCount.Read(reader, 0) : reader.GetInt32(0),
            Count2 = reader.IsDBNull(1) ? null : global::Qread.TypeReaders.TryGetReader<Int32>(out var readerCount2) ? readerCount2.Read(reader, 1) : reader.GetInt32(1)
        };
        return instance;
    }
