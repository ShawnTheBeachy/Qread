...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        var instance = new global::TestNamespace.TestDto
        {
            ...
            Count2 = reader.IsDBNull(1) ? null : global::Qread.TypeReaders.TryGetReader<int>(out var readerCount2) && readerCount2 is not null ? readerCount2.Read(reader, 1) : reader.GetInt32(1)
        };
        return instance;
    }
