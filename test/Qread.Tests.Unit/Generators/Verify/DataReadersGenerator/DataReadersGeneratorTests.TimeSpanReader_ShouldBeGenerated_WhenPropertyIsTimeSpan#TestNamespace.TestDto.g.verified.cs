...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        ...
        {
            Duration = global::Qread.TypeReaders.TryGetReader<System.TimeSpan>(out var readerDuration) && readerDuration is not null ? readerDuration.Read(reader, 0) : (TimeSpan)reader.GetValue(0)
        };
        return instance;
    }
