...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        var instance = new global::TestNamespace.TestDto
        {
            ...
            IsDisabled2 = reader.IsDBNull(1) ? null : global::Qread.TypeReaders.TryGetReader<bool>(out var readerIsDisabled2) && readerIsDisabled2 is not null ? readerIsDisabled2.Read(reader, 1) : reader.GetBoolean(1)
        };
        return instance;
    }
