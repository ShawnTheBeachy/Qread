...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        var instance = new global::TestNamespace.TestDto
        {
            ...
            Value2 = reader.IsDBNull(1) ? null : global::Qread.TypeReaders.TryGetReader<float>(out var readerValue2) && readerValue2 is not null ? readerValue2.Read(reader, 1) : reader.GetFloat(1)
        };
        return instance;
    }
