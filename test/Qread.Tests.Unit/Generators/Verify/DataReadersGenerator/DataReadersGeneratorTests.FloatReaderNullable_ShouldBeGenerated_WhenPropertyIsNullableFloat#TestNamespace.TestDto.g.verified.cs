...
partial record TestDto
{
    public static global::TestNamespace.TestDto FromDataReader(IDataReader reader)
    {
        ...
        {
            Value = reader.IsDBNull(0) ? null : global::Qread.TypeReaders.TryGetReader<float>(out var readerValue) && readerValue is not null ? readerValue.Read(reader, 0) : reader.GetFloat(0),
            Value2 = reader.IsDBNull(1) ? null : global::Qread.TypeReaders.TryGetReader<Single>(out var readerValue2) && readerValue2 is not null ? readerValue2.Read(reader, 1) : reader.GetFloat(1)
        };
        return instance;
    }
